...
{
    if (check_attribute_sign(table_oid, attnum, roleid, mask) == false)
    {
        return 0;
    }
    AclMode result;
...
{
    if (check_table_sign(table_oid, roleid, mask) == false)
    {
        return 0;
    }
    AclMode result;
...
{
    if (check_database_sign(db_oid, roleid, mask) == false)
    {
        return 0;
    }
    AclMode result;
...
{
    if (check_namespace_sign(nsp_oid, roleid, mask) == false)
    {
        return 0;
    }
    AclMode result;
