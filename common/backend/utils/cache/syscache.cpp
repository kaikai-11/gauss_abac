...
static const struct cachedesc cacheinfo[] = {{AggregateRelationId, /* AGGFNOID */
    ...
    {PackageRelationId, /* PKGNAMENSP */
        ...
        2048},
    {LevelSecRelationId, /* ABACLEVELOID */
        AbacLevelOidIndexId,
        1,
        {ObjectIdAttributeNumber, 0, 0, 0},
        1024},
    {LevelSecRelationId, /* ABACLEVELGRADE */
        AbacLevelGradeIndexId,
        1,
        {Anum_abac_level_grade, 0, 0, 0},
        1024},
    {DomainSecRelationId, /* ABACDOMAINOID */
        AbacDomainOidIndexId,
        1,
        {ObjectIdAttributeNumber, 0, 0, 0},
        1024},
    {DomainSecRelationId, /* ABACDOMAINID */
        AbacDomainIdIndexId,
        1,
        {Anum_abac_domain_id, 0, 0, 0},
        1024},
    {AttributesRelationId, /* ABACATTRIBUTESOID */
        AbacAttributesOidIndexId,
        1,
        {ObjectIdAttributeNumber, 0, 0, 0},
        1024},
    {AttributesRelationId, /* ABACATTRIBUTESNAME */
        AbacAttributesNameIndexId,
        1,
        {Anum_abac_attributes_name, 0, 0, 0},
        1024},
    {PolicysRelationId, /* ABACPOLICIESOID */
        AbacPoliciesOidIndexId,
        1,
        {ObjectIdAttributeNumber, 0, 0, 0},
        1024},
    {PolicysRelationId, /* ABACPOLICIESNAME */
        AbacPoliciesNameIndexId,
        1,
        {Anum_abac_policies_name, 0, 0, 0},
        1024},
    {AttributesManagerRelationId, /* ABACATTRIBUTESMANAGEROID */
        AbacAttributesManagerOidIndexId,
        1,
        {ObjectIdAttributeNumber, 0, 0, 0},
        1024},
    {AttributesManagerRelationId, /* ABACATTRIBUTESMANAGEROBJECTNAMEVALUE */
        AbacAttributesManagerObjectNameValueIndexId,
        3,
        {Anum_abac_attributes_manager_object, Anum_abac_attributes_manager_attribute_name, Anum_abac_attributes_manager_attribute_value, 0},
        1024}
};
