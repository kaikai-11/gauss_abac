...
/* name, value, category */
PG_KEYWORD("abac", ABAC, UNRESERVED_KEYWORD)
...
PG_KEYWORD("column_args", COLUMN_ARGS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("column_function", COLUMN_FUNCTION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("global_function", GLOBAL_FUNCTION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("nlssort", NLSSORT, RESERVED_KEYWORD)
