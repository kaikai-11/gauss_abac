...
DATA(insert OID = 4472 ( _abacAttType		PGNSP PGUID -1 f b A f t \054 0 4473 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4473 ( abacAttType		PGNSP PGUID 4 t e E f t \054 0 0 4472 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACATTTYPEOID 4473

DATA(insert OID = 4474 ( _abacAttManagerObjectType		PGNSP PGUID -1 f b A f t \054 0 4475 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4475 ( abacAttManagerObjectType		PGNSP PGUID 4 t e E f t \054 0 0 4474 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACATTMANAGEROBJECTTYPEOID 4475

DATA(insert OID = 4476 ( _abacPolicyObjectType		PGNSP PGUID -1 f b A f t \054 0 4477 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4477 ( abacPolicyObjectType		PGNSP PGUID 4 t e E f t \054 0 0 4476 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACPOLICYOBJECTTYPEOID 4477

DATA(insert OID = 4478 ( _abacPolicyActionType		PGNSP PGUID -1 f b A f t \054 0 4479 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4479 ( abacPolicyActionType		PGNSP PGUID 4 t e E f t \054 0 0 4478 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACPOLICYACTIONTYPEOID 4479

DATA(insert OID = 4480 ( _abacPolicyOperator		PGNSP PGUID -1 f b A f t \054 0 4481 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4481 ( abacPolicyOperator		PGNSP PGUID 4 t e E f t \054 0 0 4480 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACPOLICYOPERATOROID 4481

DATA(insert OID = 4482 ( _abacPolicyTag		PGNSP PGUID -1 f b A f t \054 0 4483 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
DATA(insert OID = 4483 ( abacPolicyTag		PGNSP PGUID 4 t e E f t \054 0 0 4482 enum_in enum_out enum_recv enum_send - - - i p f 0 -1 0 0 _null_ _null_ _null_ ));
#define ABACPOLICYTAGOID 4483
