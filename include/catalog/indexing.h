...
// Add for ABAC
/* Add index for abac_level */
DECLARE_UNIQUE_INDEX(abac_level_oid_index, 556, on abac_level using btree(oid oid_ops));
#define AbacLevelOidIndexId 556
DECLARE_UNIQUE_INDEX(abac_level_grade_index, 557, on abac_level using btree(grade int4_ops));
#define AbacLevelGradeIndexId 557

/* Add index for abac_domain */
DECLARE_UNIQUE_INDEX(abac_domain_oid_index, 558, on abac_domain using btree(oid oid_ops));
#define AbacDomainOidIndexId 558
DECLARE_UNIQUE_INDEX(abac_domain_id_index, 559, on abac_domain using btree(id int4_ops));
#define AbacDomainIdIndexId 559

/* Add index for abac_attributes */
DECLARE_UNIQUE_INDEX(abac_attributes_oid_index, 560, on abac_attributes using btree(oid oid_ops));
#define AbacAttributesOidIndexId 560
DECLARE_UNIQUE_INDEX(abac_attributes_name_index, 561, on abac_attributes using btree(name name_ops));
#define AbacAttributesNameIndexId 561

/* Add index for abac_policies */
DECLARE_UNIQUE_INDEX(abac_policies_oid_index, 562, on abac_policies using btree(oid oid_ops));
#define AbacPoliciesOidIndexId 562
DECLARE_UNIQUE_INDEX(abac_policies_name_index, 563, on abac_policies using btree(name name_ops));
#define AbacPoliciesNameIndexId 563

/* Add index for abac_attributes_manager */
DECLARE_UNIQUE_INDEX(abac_attributes_manager_oid_index, 564, on abac_attributes_manager using btree(oid oid_ops));
#define AbacAttributesManagerOidIndexId 564
DECLARE_INDEX(abac_attributes_manager_object_name_value_index, 565, on abac_attributes_manager using btree(object name_ops, attribute_name name_ops, attribute_value name_ops));
#define AbacAttributesManagerObjectNameValueIndexId 565
