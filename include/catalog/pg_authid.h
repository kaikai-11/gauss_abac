...
DATA(insert OID = 1038 ( "gs_role_abac_manager" f t f f f f f f t -1 _null_ _null_ _null_ "default_pool" f 0 _null_ n 0 _null_ _null_ _null_ f f f));
...
#define DEFAULT_ROLE_ABAC_MANAGER 1038
